  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center pt-16 overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
        ...
        >
          <a
            href="https://testflight.apple.com/join/lockin"
            className="group relative inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-gradient-to-r from-[#FFD60A] to-[#FF9500] text-black font-semibold text-base transition-all duration-200 hover:scale-105 hover:shadow-[0_0_40px_rgba(255,214,10,0.3)]"
          >
        ...
        <div className="relative">
          ...
          <div className="relative z-10">
            ...
            <p className="text-zinc-400 text-lg mb-10 max-w-md mx-auto">
              Join the beta and start holding your friends accountable today.
            </p>
            <a
              href="https://testflight.apple.com/join/lockin"
              className="inline-flex items-center gap-2 px-10 py-5 rounded-xl bg-gradient-to-r from-[#FFD60A] to-[#FF9500] text-black font-semibold text-lg transition-all duration-200 hover:scale-105 hover:shadow-[0_0_60px_rgba(255,214,10,0.3)]"
            >
